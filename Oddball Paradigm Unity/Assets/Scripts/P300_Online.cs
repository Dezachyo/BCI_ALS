...
public class P300_Online : MonoBehaviour
{
    ...
    public GameObject LSLReciverGameObject;
    ...
    [Header("LSL")] 
    string StreamName = "P300_Markers";
    ...
    void Start()
    {
        ...
        stimulusPresentationDuration = UnityEngine.Random.Range(0.5f, 0.7f); // Create Jitter 
        ISI = UnityEngine.Random.Range(0.3f, 0.6f); // Create Jitter
    ...
    // The P300 Task Manger
    IEnumerator P300Task()
            {
                // Start Task - show instructions
                ...
                for (int i = 0; i < numberOfBlocks; i++)
                {
                    ...
                    foreach (int trialType in trialTypeList)
                        ...
                        // Break/Decision
                        textText.text = "";
                        LSLReciverGameObject.SetActive(true);
                        if (outlet != null)
                            {
                                sample[0] = "Break";
                                UnityEngine.Debug.Log(sample[0]);
    ...
    private void ResetParameters()
    {
        ...
        textGameobject.SetActive(true);
        background.SetActive(true);
        textText.color = new Color(0, 0, 0, 255);
